...
export function FlowNode({ data }: FlowNodeProps) {
  ...
  return (
    <div
      className={`px-4 py-3 rounded-lg border-2 shadow-md min-w-[180px] max-w-[240px] ${getTypeColor()}`}
    >
      ...
      {screen.description && (
        <div className="text-xs text-gray-500 mb-3 line-clamp-2 break-words overflow-hidden">
          {screen.description}
        </div>
      )}
